...
public class GroceryListDataSource {
    ...
    public void refreshData()
    {
        if(!GroceryList.isEmpty()){
            ...
            GroceryList.add(new Item(1, "Protein Shake", false, false, MainActivity.ownerName, R.drawable.protein_shake));
            GroceryList.add(new Item(2, "Pop Tarts", false, false, MainActivity.ownerName, R.drawable.pop_tarts));
            GroceryList.add(new Item(3, "Mtn Dew", false, false, MainActivity.ownerName, R.drawable.mtn_dew));
            GroceryList.add(new Item(4, "Pretzels", false, false, MainActivity.ownerName, R.drawable.pretzels));
            GroceryList.add(new Item(5, "Shampoo", false, false, MainActivity.ownerName, R.drawable.shampoo));
            GroceryList.add(new Item(6, "Cheese", false, false, MainActivity.ownerName, R.drawable.cheese));
